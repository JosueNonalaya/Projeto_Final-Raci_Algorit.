...
catalg_films = {"aventura":["Back to the Future I","Goonies","Senhor dos aneis"],
                   "açao":["Terminator II", "James Bond:NO TIME TO DIE","Missão Impossível III"],
                   "comédia":["Escola de Rock", "Free Guy"]
                   }
...
def add_film()
    ...
    genero = input("Em qual genero  voce gostaria de adicionar o filme")
